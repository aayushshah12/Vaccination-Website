        ...
        <form method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col mb">
                    ...
                    <input type="number" class="form-control" id="AdhaarCard_No" placeholder="Enter the Adhaar Card No" name="adhaar_no">
                </div>
            ...
            <div class="row">
                <div class="col mb">
                    ...
                    <input type="email" class="form-control" id="email" placeholder="ex: abc@gmail.com" name="email">
                </div>
                <div class="col mb">
                    <label for="phone" class="form-label">Phone no</label>
                    <input type="number" class="form-control" id="phone" placeholder="Enter Your Phone Number" name="cnumber">
                </div>
                <div class="col mb">
            ...
            <div class="row">
                <input type="submit" name="signin" class="btn btn-primary btn-lg" value="Register">
            </div>
        </form>
    </div>
</body>
...
<?php
  include('db_connect.php');
    ...
    if(isset($_POST["signin"])){
      ...
      $sql1="SELECT * FROM user_details where adhaar_no='$adhaar_no'";
      ...
      {
        $result = mysqli_query($connect,"INSERT INTO user_details(`full_name`, `adhaar_no`,`age`, `gender`, `email`, `cnumber`, `pincode`, `address`,`account_status`) VALUES ('$full_name','$adhaar_no','$age','$gender','$email','$cnumber','$pincode','$address','Owner')");
          ...
          if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) 
          {
            ...
            if($result_file = TRUE) { ?>
                  <script type="text/javascript">
                    $(document).ready(function() {
                        swal({
                            title: "Vaccine Registration done Successfully!",
                            icon: "success",
                            timer: 2000,
                            button: false,
                            timerProgressBar:true,
